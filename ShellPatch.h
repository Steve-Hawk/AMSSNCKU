//$Id: ShellPatch.h,v 1.1.1.1 2012/02/03 08:46:28 zjcao Exp $
#ifndef SHELLPATCH_H
#define SHELLPATCH_H
...
{
public:
   xp_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=2;};
   void setupcordtrans();
};
...
{
public:	
   xm_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=3;};
   void setupcordtrans();
};
class yp_patch: public ss_patch
{
public:	
   yp_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=4;};
   void setupcordtrans();
};
...
{
public:	
   ym_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=5;};
   void setupcordtrans();
};
class zp_patch: public ss_patch
{
public:	
   zp_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=0;};
   void setupcordtrans();
};
...
{
public:	
   zm_patch(int ingfsi, int fngfsi,int *shapei,double *bboxi,int myranki):
	   ss_patch(ingfsi,fngfsi,shapei,bboxi,myranki){sst=1;};
   void setupcordtrans();
};
// Shell Patch system
...
public:
   ...
   ShellPatch(int ingfsi, int fngfsi,int *shapei, double *Rrangei,int Symmetry,int myranki);
