//$Id: scalar_rhs.h,v 1.1.1.1 2012/02/03 08:46:28 zjcao Exp $
#ifndef SCALAR_RHS_H
#define SCALAR_RHS_H
...
#endif
extern "C" { int f_compute_rhs_scalar(int *, double &,double *, double *,double *,  //ex,T,X,Y,Z
		                double *, double *,                     //Sphi,Spi
		                double *, double *,                     //Sphi_rhs,Spi_rhs
				int &,int &,double &);}

extern "C" { int f_compute_rhs_scalar_ss(int *, double &,double *, double *,double *,  //ex,T,rho,sigma,R
