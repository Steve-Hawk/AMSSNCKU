//$Id: initial_scalar.h,v 1.1.1.1 2012/02/03 08:46:28 zjcao Exp $
...
extern "C" { void f_get_initial_scalar( int *, double *, double *, double *,
                                 double *, double *,
                                 double &, double &, double &);}

extern "C" { void f_get_initial_scalar_sh( int *, double *, double *, double *,
                                 double *, double *,
                                 double &, double &, double &);}
